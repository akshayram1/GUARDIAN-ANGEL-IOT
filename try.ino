...
String SOS_NUM = "+919834524009"; // Add a number on which you want to receive call or SMS
...
void setup()
{
  ...
  Serial1.println("AT+CMGF = 1");          //SEND MSG
  delay(1000);

  Serial1.println("AT+CSMP  = 17,167,0,0 ");  //CONFIG
  delay(1000);
